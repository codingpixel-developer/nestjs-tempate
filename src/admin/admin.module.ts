...
import { AdminLoginProvider } from './providers/admin-login.provider';
import { HashingProvider } from '@/auths/providers/hashing.provider';
import { BcryptProvider } from '@/auths/providers/bcrypt.provider';
...
import { AdminChangePasswordProvider } from '@/admin/providers/admin-change-password.provider';
